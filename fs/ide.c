...
void ide_read(u_int diskno, u_int secno, void* dst, u_int nsecs)
{
    ...
    while (secno < max) {
        ...
        for (int i = 0; i < SECT_SIZE / 4; i++) {
            // va:dst+offset+i*4  pa:MALTA_IDE_DATA len:4
...
void ide_write(u_int diskno, u_int secno, void* src, u_int nsecs)
{
    ...
    while (secno < max) {
        ...
        temp = 1;
        panic_on(syscall_write_dev(&temp, MALTA_IDE_NSECT, 1));
        // 设置一次需要操作的扇区的数量，本身就只有1字节，怎么写更多嘛（
...
//     u_int flag;
//     while (1) {
//         flag = *((volatile u_char*)(MALTA_IDE_STATUS + KSEG1));
//         if ((flag & MALTA_IDE_BUSY) == 0)
//             break;
//     }
//     return flag;
...
//     *((volatile u_char*)(MALTA_IDE_NSECT + KSEG1)) = 1;
//     *((volatile u_char*)(MALTA_IDE_LBAL + KSEG1)) = secno & 0xff;
//     *((volatile u_char*)(MALTA_IDE_LBAM + KSEG1)) = (secno >> 8) & 0xff;
//     *((volatile u_char*)(MALTA_IDE_LBAH + KSEG1)) = (secno >> 16) & 0xff;
//     *((volatile u_char*)(MALTA_IDE_DEVICE + KSEG1)) = ((secno >> 24) & 0x0f) | MALTA_IDE_LBA | (diskno << 4);
//     *((volatile u_char*)(MALTA_IDE_STATUS + KSEG1)) = MALTA_IDE_CMD_PIO_READ;

//     wait_ide();

//     for (int i = 0; i < SECT_SIZE; i += 4) {
//         memcpy(dst + i, (void*)(MALTA_IDE_DATA + KSEG1), 4);
//     }
// }
...
//     *((volatile u_char*)(MALTA_IDE_LBAH + KSEG1)) = (secno >> 16) & 0xff;
//     *((volatile u_char*)(MALTA_IDE_DEVICE + KSEG1)) = ((secno >> 24) & 0x0f) | MALTA_IDE_LBA | (diskno << 4);
//     *((volatile u_char*)(MALTA_IDE_STATUS + KSEG1)) = MALTA_IDE_CMD_PIO_WRITE;

//     wait_ide();

//     for (int i = 0; i < SECT_SIZE; i += 4) {
//         memcpy((void*)(MALTA_IDE_DATA + KSEG1), src + i, 4);
//     }
// }